...
| 2026-05-31 | **VALIDATION §1.2** — plain SAC 4 method(start×on-miss) 3seed×400k. **통일 eval(continue_on_miss, 10샷)** random start: rand_cont 0.453(최고·최저분산) > rand_reset 0.41 > canon_cont 0.35 ≫ canon_reset 0.073(overfit 전멸). continue_on_miss가 지배 요인, canon_cont도 state diversity로 선전. **training curve↔eval 역전** → 통일 eval 필수. `valid_learnmethod/`, §1.2 |
